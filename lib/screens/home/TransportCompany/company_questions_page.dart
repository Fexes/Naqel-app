...
import 'package:progress_dialog/progress_dialog.dart';
      ...
      class _PermitPageState extends State<CompanyQuestionsPage>  {
        ...
        Future<void> loadQuestions() async {
          ...
          try{
          final request = await client.getUrl(Uri.parse(URLs.getTransportCompanyResponsiblegetQuestionsURL()));
          ...
          response.transform(utf8.decoder).listen((contents) async {
            ...
            DataStream.companyQuestions = DataStream.parseCompanyQuestions(map["Questions"]);
            print(map["Questions"]);
