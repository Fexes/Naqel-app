...
// Changes the selected value on 'onChanged' click on each radio button
  ...
  Future<void> loadlicence() async {
    ...
    try {
      final request =
          await client.getUrl(Uri.parse(URLs.getDrivingLicenceURL()));
      request.headers.set(
  ...
  Future<void> loadentryexit() async {
    ...
    try {
      final request =
          await client.getUrl(Uri.parse(URLs.getEntryExitCardURL()));
      request.headers.set(
          HttpHeaders.contentTypeHeader, "application/json; charset=UTF-8");
      request.headers.add("Authorization", "JWT " + DataStream.token);
      final response = await request.close();
  ...
  Widget build(BuildContext context) {
      ...
      child: Row(
        children: <Widget>[
          Icon(
            ...
            color: DataStream.driverProfile.FirstName == ""
                ? Colors.redAccent
                : Colors.black,
          ),
          Container(
    ...
    Widget lastNameForm = Container(
      ...
      child: Row(
        children: <Widget>[
          Icon(
            Icons.account_circle,
            color: DataStream.driverProfile.LastName == ""
                ? Colors.redAccent
                : Colors.black,
          ),
          Container(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: TextFormField(
              ...
              onSaved: (String value) {
                if (!value.isEmpty) mobilenumber = value;
              },
              validator: (String value) {
                if (value.length != 11)
    ...
    Widget addressForm = Container(
      ...
      child: Row(
        children: <Widget>[
          Icon(
            Icons.home,
            color: DataStream.driverProfile.Address == ""
                ? Colors.redAccent
                : Colors.black,
          ),
          Container(
    ...
    Widget nationalityForm = Row(
      ...
      children: <Widget>[
        Icon(
          Icons.local_airport,
          color: DataStream.driverProfile.Nationality == ""
              ? Colors.redAccent
              : Colors.black,
        ),
        Row(
                        ...
                        children: <Widget>[
                          Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.only(top: 18, left: 4),
                                child: Text(
  ...
  Future updateSettings(BuildContext context) async {
    if (isNumeric(mobilenumber)) {
      ...
      try {
        final request =
            await client.postUrl(Uri.parse(URLs.generalSettingUrl()));
        request.headers.set(
            HttpHeaders.contentTypeHeader, "application/json; charset=UTF-8");
        request.headers.add("Authorization", "JWT " + DataStream.token);

        request.write('{"FirstName": "' +
            first_name +
            '","LastName": "' +
            last_name +
            '", "Address": "' +
    ...
    if (EmailValidator.validate(email)) {
      ...
      try {
        ...
        response.transform(utf8.decoder).listen((contents) async {
          print(contents);
          ToastUtils.showCustomToast(
              context, "Email Updated Successfully", true);
  ...
  Future updatePassword(BuildContext context) async {
    ...
    if (password == password2 && (password != "" || password2 != "")) {
      ...
      try {
        final request =
            await client.postUrl(Uri.parse(URLs.passwordSettingUrl()));
        request.headers.set(
            HttpHeaders.contentTypeHeader, "application/json; charset=UTF-8");
        request.headers.add("Authorization", "JWT " + DataStream.token);
  ...
  Future updatePicUrl(String s) async {
    ...
    try {
      final request =
          await client.postUrl(Uri.parse(URLs.updatePhotoUrlInDatabase()));
      request.headers.set(
          HttpHeaders.contentTypeHeader, "application/json; charset=UTF-8");
      request.headers.add("Authorization", "JWT " + DataStream.token);
  ...
  Future uploadLicencePic() async {
    ...
    StorageReference firebaseStorageRef =
        FirebaseStorage.instance.ref().child("Licence").child("$driver_id");
  ...
  Future<void> addLicence(String s) async {
    ...
    try {
      final request =
          await client.postUrl(Uri.parse(URLs.addDrivingLicenceURL()));
      request.headers.set(
          HttpHeaders.contentTypeHeader, "application/json; charset=UTF-8");
      request.headers.add("Authorization", "JWT " + DataStream.token);

      request.write('{"LicenceNumber": "' +
          LicenceNumber +
          '", "Type": "' +
          LicenceType +
          '", "ReleaseDate": "' +
  ...
  Future<void> deleteEnteryExit() async {
    ...
    try {
      final request =
          await client.deleteUrl(Uri.parse(URLs.deleteEntryExitCardURL()));
      request.headers.set(
          HttpHeaders.contentTypeHeader, "application/json; charset=UTF-8");
      request.headers.add("Authorization", "JWT " + DataStream.token);
      final response = await request.close();
  ...
  Future<void> deleteIdCard() async {
    ...
    try {
      final request =
          await client.deleteUrl(Uri.parse(URLs.deleteIdentityCardURL()));
      request.headers.set(
          HttpHeaders.contentTypeHeader, "application/json; charset=UTF-8");
      request.headers.add("Authorization", "JWT " + DataStream.token);
      final response = await request.close();
  ...
  Future<void> deleteLicence() async {
    ...
    try {
      final request =
          await client.deleteUrl(Uri.parse(URLs.deleteDrivingLicenceURL()));
      request.headers.set(
          HttpHeaders.contentTypeHeader, "application/json; charset=UTF-8");
      request.headers.add("Authorization", "JWT " + DataStream.token);
      final response = await request.close();
  ...
  Future<void> addIdcard(String s) async {
    ...
    try {
      final request =
          await client.postUrl(Uri.parse(URLs.addIdentityCardURL()));
      request.headers.set(
          HttpHeaders.contentTypeHeader, "application/json; charset=UTF-8");
      request.headers.add("Authorization", "JWT " + DataStream.token);

      request.write(
          '{"IDNumber": "' + identityCard + '",  "PhotoURL": "' + s + '"}');
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              onSaved: (String value) {
                                if (!value.isEmpty) LicenceNumber = value;
                              },
                              validator: (String value) {
                      ...
                      decoration: new BoxDecoration(
                        border: new Border(
                          bottom: _focusNodeLicencenumber.hasFocus
                              ? BorderSide(
                                  color: Colors.black,
                                  style: BorderStyle.solid,
                                  width: 2.0)
                    ...
                    Container(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              onSaved: (String value) {
                                if (!value.isEmpty) LicenceType = value;
                      ...
                      decoration: new BoxDecoration(
                        border: new Border(
                          bottom: _focusNodLicenceype.hasFocus
                              ? BorderSide(
                                  color: Colors.black,
                                  style: BorderStyle.solid,
                                  width: 2.0)
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              onSaved: (String value) {
                                if (!value.isEmpty) identityCard = value;
                              },
                              validator: (String value) {
                                if (value.length == null)
                      ...
                      decoration: new BoxDecoration(
                        border: new Border(
                          bottom: _focusNodeIdentityCard.hasFocus
                              ? BorderSide(
                                  color: Colors.black,
                                  style: BorderStyle.solid,
                                  width: 2.0)
